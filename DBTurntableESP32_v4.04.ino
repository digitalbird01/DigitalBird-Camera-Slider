...
int JB;                                              //Is the Jib present 1,0,2
//Sequencer
int SEQ = 0;
...
typedef struct struct_message {
  ...
  int TT;                                             //Is the turntable present 0,1,2
...
void Start_2() {
  ...
  if (Bounce >= 1 && Sld != 0) {                                                   //If the slider is present give it control of the bounce moves
    while (Sld != 2) {
      delay(2);
    }
    Sld = 1;
    ...
    if (Bounce >= 1 && PT != 0) {                                                   //If the slider is present give it control of the bounce moves
      while (PT != 2) {
        delay(2);
      }
      PT = 1;
      ...
      if (Bounce >= 1 && JB != 0) {                                                   //If the slider is present give it control of the bounce moves
        while (JB != 2) {
          delay(2);
        }
        JB = 1;
  ...
  if (Bounce >= 1) {
    ...
    if (Sld != 0) {                                                   //If the slider is present give it control of the bounce moves
      while (Sld != 2) {
        delay(2);
      }
      Sld = 1;
...
//  }
//
//  if (Sld == 0 && PT == 0) {                              //Only take charge of the counting if no slider & no PanTilt head
//    Bounce = Bounce - 1;
//    But_Com = 6;                                         //Send current bounce counter back to nextion
//    if (PTZ_Cam == 0) {
//      SendNextionValues();
