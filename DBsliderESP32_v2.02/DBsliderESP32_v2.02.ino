...
void receiveCallback(const uint8_t *macAddr, const uint8_t *incomingData,  int Len) {
  ...
  //  Serial.print("\nk1P= ");
  //  Serial.print(incomingValues.k1P);
  //  Serial.print("\nk2P=");
  //  Serial.print(incomingValues.k2P);
  //  Serial.print("\nkprs= ");
  //  Serial.print(incomingValues.k3P);
  //  Serial.print("\nk4P= ");
  //  Serial.print(incomingValues.k4P);
  //  Serial.print("\nk5P= ");
  //  Serial.print(incomingValues.k5P);
  //  Serial.print("\nk6P= ");
  //  Serial.print(incomingValues.k6P);
  //
  //  Serial.print("\nk1s= ");
  //  Serial.print(incomingValues.k1s);
  //  Serial.print("\nk2s=");
  //  Serial.print(incomingValues.k2s);
  //  Serial.print("\nk3s= ");
  //  Serial.print(incomingValues.k3s);
  //  Serial.print("\nk4s= ");
  //  Serial.print(incomingValues.k4s);
  //  Serial.print("\nk5s= ");
  //  Serial.print(incomingValues.k5s);
  //  Serial.print("\nk6s= ");
  //  Serial.print(incomingValues.k6s);
