//Digital Bird Camera Slide v4.02 Aug 2022//
...
void Start_2() {
  ...
  if (Bounce >= 1) {
    delay(700);                                         //1 sec delay at the start and end of each bounce move
    Sld = 2;
  }
  ...
  But_Com = 0;
  Sld = 1;
 // delay(100);                                                       //Start delay allowance for slave devices to keep up
