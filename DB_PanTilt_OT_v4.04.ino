...
void Start_2() {
  ...
  if (Bounce >= 1) {
    ...
    delay(1000);
    if (Sld == 0 ) {                                           //Only take charge of the counting if no slider & no PanTilt head and no JIB present
      Bounce = Bounce - 1;
...
void Start_4() {
  ...
  while (Tps >= 1) {
    //Oledmessage()
    if (Sld > 0 ) {                                                             //If Slider is conected give slider control over timing
