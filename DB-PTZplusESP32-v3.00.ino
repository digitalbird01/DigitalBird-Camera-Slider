//DBNextionESP32 V3.00
//* Digital Bird Motion Control System PTZplus Remote firmware
//This software should be installed on the PTZplus remote ESP32.//
//Written by Colin Henderson April 2022
...
int PTZ_Cam = 0;                          //Current PTZ camera defaulted to 4 can be 1-3
...
String DBFirmwareVersion = "DBv3.00";
...
const int NexBat = 36;                      //Battery monitoring pin
//PTZ Play button
